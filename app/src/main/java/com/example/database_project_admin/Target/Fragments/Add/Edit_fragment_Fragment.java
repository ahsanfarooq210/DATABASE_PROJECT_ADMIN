...
//variables
    ...
    private Button edit_target_button;
    //database reference
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        rally3 = v.findViewById(R.id.edit_target_bottom);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rally3 = view.findViewById(R.id.edit_target_bottom);
        ...
        skuSpinner =  view.findViewById(R.id.edit_target_Sku_spinner);
        ...
        edit_target_button =  view.findViewById(R.id.edit_target_button);
